...
d.raw<-read_csv("data/Processed_data.csv")
```
...
p3<- p2 + new_scale_fill()+ geom_fruit(geom=geom_tile, mapping=aes(fill=direct_persistent),offset=0.1,width=0.07, col="black", size=0.3)+scale_fill_manual(values=c("#EAD295","#9994EA","#95EA99"), name="Design")+theme(legend.direction = "vertical")
