---
title: "Statistical Analyses - Developmental plasticity of heat tolerance"
author: Patrice Pottier, Samantha Burke, Rose Zhang, Szymon Drobniak, Daniel Noble,
  Lisa Schwanz, Shinichi Nakagawa
...
Here, we iteratively removed one study, one species, one cohort, or one independent comparison at a time and investigated how it affected the overall mean. 
...
```{r LOO_shared_trt_results, fig.height=8, fig.width=12}
...
ggsave("output/habitat_metareg_pub.svg", width=12, height=8, dpi=800)
